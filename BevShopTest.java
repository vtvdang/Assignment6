...
public class BevShopTest {
	...
	public void testProcessAlcoholOrder()
	{
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(0).getBevType().equals(TYPE.ALCOHOL));	
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(1).getBevType().equals(TYPE.ALCOHOL));	
		assertTrue(bevShop.eligibleForMore());
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(2).getBevType().equals(TYPE.ALCOHOL));	
	...
	public void testProcessSmoothieOrder()
	{
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(0).getBevType().equals(TYPE.SMOOTHIE));
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(1).getBevType().equals(TYPE.SMOOTHIE));
	...
	public void testProcessCoffeeOrder()
	{
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(0).getSize().equals(SIZE.SMALL));
		assertTrue(bevShop.getCurrentOrder().getBeverage(0).getBevType().equals(TYPE.COFFEE));
		...
		assertTrue(bevShop.getCurrentOrder().getBeverage(1).getSize().equals(SIZE.LARGE));
		assertTrue(bevShop.getCurrentOrder().getBeverage(1).getBevType().equals(TYPE.COFFEE));
